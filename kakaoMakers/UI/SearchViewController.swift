...
//            let headerView = searchCollectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "searchResuableView", for: indexPath) as! SearchCollectionReusableView
//            return headerView
//        default:
//            assert(false)
//        }
