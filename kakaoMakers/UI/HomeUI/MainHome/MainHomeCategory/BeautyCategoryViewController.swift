...
class BeautyCategoryViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        beautyCollectionView.autoresizingMask = [.flexibleWidth, .flexibleHeight]
        ...
        beautyCollectionView.register(nibName, forCellWithReuseIdentifier: "categoryCollectionViewCell")
...
extension BeautyCategoryViewController: UICollectionViewDelegate {
    
    
}

extension BeautyCategoryViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = beautyCollectionView.dequeueReusableCell(withReuseIdentifier: "categoryCollectionViewCell", for: indexPath) as! CategoryCollectionViewCell
...
extension BeautyCategoryViewController: UICollectionViewDelegateFlowLayout {
